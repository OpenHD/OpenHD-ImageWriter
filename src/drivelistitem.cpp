...
DriveListItem::DriveListItem(QString device, QString description, quint64 size,bool isNet, bool isUsb, bool isScsi, bool readOnly, QStringList mountpoints, QObject *parent)
